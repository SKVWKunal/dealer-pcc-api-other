      ...
      <div className="bg-primary text-primary-foreground shadow-lg">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold">🔧 Workshop System Survey</h1>
              <p className="text-sm opacity-90">
                Workshop Operations Feedback System
              </p>
            </div>
      ...
      <div className="container mx-auto px-4 py-6">
        {isDealer ? (
          <div className="space-y-6">
            <Card>
              <CardHeader>
                <CardTitle>Submit Workshop Survey</CardTitle>
                <CardDescription>
                  Provide feedback on workshop systems and operations
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  View your previous survey responses
                </CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <div className="space-y-6">
            <Card>
              <CardHeader>
                <CardTitle>All Workshop Surveys</CardTitle>
                <CardDescription>
                  View and analyze dealer workshop survey responses
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="text-center py-8 text-muted-foreground">
